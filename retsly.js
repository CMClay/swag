...
require.register("retsly~ajax@0.0.4", function (exports, module) {
var type
try {
...
var ajax = module.exports = function(options){
  ...
  // test for ie89
  //   assign callback function based on browser
  var ie = xhr instanceof XMLHttpRequest;
  (ie)
    ? xhr.onreadystatechange = XHROnReady
    : xhr.onload = XDROnLoad;

  function XDROnLoad() { ajaxSuccess(this.responseText, xhr, settings); }
  ...
  if (ie) for (name in settings.headers) xhr.setRequestHeader(name, settings.headers[name])
...
ajax.settings = {
  ...
  // Transport
  xhr: function () {
    return (testIE()) ? new XDomainRequest() : new window.XMLHttpRequest();
  },
  // MIME types mapping
  accepts: {
...
function testIE() {
  return (/msie [89]/i.test(navigator.userAgent) && window.XDomainRequest)
    ? true
    : false;
}
...
require.register("retsly~qs@v2.3.4", function (exports, module) {
module.exports = require('retsly~qs@v2.3.4/lib/index.js');

});

require.register("retsly~qs@v2.3.4/lib/index.js", function (exports, module) {
// Load modules

var Stringify = require('retsly~qs@v2.3.4/lib/stringify.js');
var Parse = require('retsly~qs@v2.3.4/lib/parse.js');
...
require.register("retsly~qs@v2.3.4/lib/parse.js", function (exports, module) {
// Load modules

var Utils = require('retsly~qs@v2.3.4/lib/utils.js');
...
require.register("retsly~qs@v2.3.4/lib/stringify.js", function (exports, module) {
// Load modules
...
require.register("retsly~qs@v2.3.4/lib/utils.js", function (exports, module) {
// Load modules
...
var ajax = require('retsly~ajax@0.0.4');
var each = require('component~each@0.2.5');
var qs = require('retsly~qs@v2.3.4').stringify;
...
if (typeof exports == "object") {
  ...
  define("Retsly", [], function(){ return require("retsly-js-sdk"); });
} else {
  (this || window)["Retsly"] = require("retsly-js-sdk");
}
})()
